  ...
  return (
    <label className="grid gap-2 text-sm font-medium text-text-secondary" htmlFor={inputId}>
      ...
      <textarea
        ...
        className={cn(
          "min-h-24 w-full resize-y rounded-md border bg-background-card/90 px-3 py-2.5 text-sm text-text-primary shadow-sm outline-none transition duration-150 ease-out",
